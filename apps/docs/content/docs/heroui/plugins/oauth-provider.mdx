...
`<AuthorizedApplications />` is registered as a security card and lists everything the user has authorized: client name and logo, granted scopes through the same scope resolver, the latest authorization date, and a "Remove authorization" action confirmed through a HeroUI `AlertDialog`.
...
<auto-type-table path="../../../../../../packages/heroui/src/components/auth/oauth-provider/oauth-sign-up.tsx" name="OAuthSignUpProps" />

<auto-type-table path="../../../../../../packages/heroui/src/components/auth/oauth-provider/oauth-select-account.tsx" name="OAuthSelectAccountProps" />

<auto-type-table path="../../../../../../packages/heroui/src/components/auth/oauth-provider/authorized-applications.tsx" name="AuthorizedApplicationsProps" />
