...
import { magicLinkPlugin } from "@better-auth-ui/heroui/plugins" // [!code highlight]
...
<auto-type-table path="../../../../../../packages/heroui/src/components/auth/magic-link/magic-link-sent.tsx" name="MagicLinkSentProps" />
