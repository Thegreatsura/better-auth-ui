...
The contents of the `settings` tab — `<OrganizationProfile />` followed by `<OrganizationDangerZone />`. Drop it into a custom layout if you don't want the tabbed shell.
