...
Keep Google in `socialProviders` as a visible fallback. One Tap is a passive prompt, and browsers can decide not to show it.
...
<auto-type-table path="../../../../../../packages/solid/src/plugins/one-tap/one-tap-plugin.tsx" name="OneTapPluginOptions" />
