...
import { oneTapPlugin } from "@better-auth-ui/solid/plugins" // [!code highlight]
...
<auto-type-table path="../../../../../../packages/solid/src/plugins/one-tap-plugin.tsx" name="OneTapPluginOptions" />
