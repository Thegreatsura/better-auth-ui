...
Run the Zaidan CLI to install the theme plugin factory, preference helpers, and copied Theme UI components:
...
<auto-type-table path="../../../../../../examples/start-solid-zaidan-example/src/components/auth/theme/appearance.tsx" name="AppearanceProps" />

## Options

<auto-type-table path="../../../../../../examples/start-solid-zaidan-example/src/lib/auth/theme-plugin.ts" name="ThemePluginOptions" />
