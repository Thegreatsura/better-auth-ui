...
import { usernameClient } from "better-auth/react" // [!code highlight]
...
import { usernamePlugin } from "@/lib/username/username-plugin" // [!code highlight]
...
<ComponentPreview name="shadcn-username-sign-in" />

### `<SignUp />`

<ComponentPreview name="shadcn-username-sign-up" />

### `<UserProfile />`

<ComponentPreview name="shadcn-username-user-profile" />
