...
<auto-type-table path="../../../../../../examples/start-shadcn-example/src/components/auth/oauth-provider/oauth-consent.tsx" name="OAuthConsentProps" />

<auto-type-table path="../../../../../../examples/start-shadcn-example/src/components/auth/oauth-provider/oauth-sign-up.tsx" name="OAuthSignUpProps" />

<auto-type-table path="../../../../../../examples/start-shadcn-example/src/components/auth/oauth-provider/oauth-select-account.tsx" name="OAuthSelectAccountProps" />

<auto-type-table path="../../../../../../examples/start-shadcn-example/src/components/auth/oauth-provider/authorized-applications.tsx" name="AuthorizedApplicationsProps" />
