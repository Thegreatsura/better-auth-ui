...
describe("Solid docs navigation", () => {
  ...
  it("documents only the Solid runtime/package track", () => {
    const expectedPages = [
      ...
      "mutations/approve-device.mdx",
      "mutations/cancel-invitation.mdx",
      "mutations/change-email-otp.mdx",
      ...
      "mutations/verify-backup-code.mdx",
      "mutations/verify-device-code.mdx",
      "mutations/verify-email-otp.mdx",
      "mutations/verify-totp.mdx",
      "mutations/verify-two-factor-otp.mdx",
